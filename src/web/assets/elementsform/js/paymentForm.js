class PaymentIntentsElements {
    ...
    deprecatedSubscribeFlow() {
        this.showErrorMessage('Can not use the Stripe payment form to subscribe. Please create a payment source first.');
        this.container.querySelector('.stripe-payment-elements-submit-button').classList.add('hidden');
    }
